...
import { generateExamFromPDF, analyzePerformance, explainPDFContent } from './services/deepseekService';
import { BrainCircuit, GraduationCap, X, Moon, Sun, Languages, ArrowLeft } from 'lucide-react';
      ...
      <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-0 z-50 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            <a
              href="index.html"
              className="p-2 -ml-2 rtl:-mr-2 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full transition-colors flex items-center justify-center"
